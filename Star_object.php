...
class Star_object{
	...
	private $evolutionByType=array(
			...
			"G"=>array(
					...
					array('label'=>"Sub-géante rouge", 'age_min'=>"8.5",'age_max'=>"9.5","code"=>"SEQSEC",'surcharge'=>"2"),
			...
			"F"=>array(
					...
					array('label'=>"géante rouge", 'age_min'=>"6.5",'age_max'=>"7","code"=>"SEQSEC",'surcharge'=>"2"),
			...
			"A"=>array(
					...
					array('label'=>"supergéante rouge", 'age_min'=>"0.25",'age_max'=>"0.3","code"=>"SEQSEC",'surcharge'=>"2"),
			...
			"B"=>array(
					...
					array('label'=>"supergéante rouge", 'age_min'=>"0.1",'age_max'=>"0.11","code"=>"SEQSEC",'surcharge'=>"2"),
					array('label'=>"Etoile à neutrons", 'age_min'=>"0.11",'age_max'=>"9999","code"=>"END",'surcharge'=>"3"),
			),
			"O"=>array(
